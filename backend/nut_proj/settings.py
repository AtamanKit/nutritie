...
CSRF_TRUSTED_ORIGINS = ['https://plafar.org']
ALLOWED_HOSTS = ['.plafar.org', 'localhost']
...
EMAIL_HOST_USER = 'plafarorg@gmail.com'
EMAIL_HOST_PASSWORD = 'bmil cvov vgke ruug'
EMAIL_PORT = 587
EMAIL_USE_TLS = True

DOMAIN = 'plafar.org'
SITE_NAME = 'PLAFAR.ORG'
